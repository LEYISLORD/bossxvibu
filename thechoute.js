...
// ☷☷ 𝐁𝐎𝐒𝐒 𝐕𝐈𝐁𝐔 $ - - @bossxvibu | ALMACENAR DATOS
...
_A continuación te muestro al creador, de preferencia solo hablale si necesitas algo, no por webadas_
...
if (test.includes(`grupo`)){
  ...
  *-Te invito a unirte al grupo de WhatsApp donde:-*
  ...
  Grupo 1 : 
  _https://chat.whatsapp.com/EuGOSVqZ8il7P7ayXvqIHdn_
...
if (test.includes(`nuevo`)){
  fansh = leo.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 0, "totalAmount1000" : '1000', "message": `${nuevo}\n\n\nCreador is 𝐁𝐎𝐒𝐒 𝐕𝐈𝐁𝐔`, "footerText": "*𝐁𝐎𝐒𝐒 𝐕𝐈𝐁𝐔*", "thumbnail": fs.readFileSync('./media/imagen/Faketumber.jpg'), "surface": 'CATALOG', "orderTitle": 'Sexo'}}, {contextInfo: { mentionedJid: [sender, ownerNumber]}, quoted:choute, })
...
if (choute.message.listResponseMessage){
  ...
  `${texto}\n${allmenu}`
    ...
    buttonsMessage = {
    contentText: `${txtt}`,
    footerText: '© Creator: 𝐁𝐎𝐒𝐒 𝐕𝐈𝐁𝐔 $', imageMessage: imageMsg,
    buttons: buttons1,
    headerType: 4}
  ...
  if (choute.message.listResponseMessage){
    ...
    leo.updatePresence(from, Presence.composing)
    if (!isRegister) return leoply(baby.only.usrReg)    
    fansh = leo.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 0, "totalAmount1000" : '1000', "message": `${menusticker}\n\n\nCreador is 𝐁𝐎𝐒𝐒 𝐕𝐈𝐁𝐔`, "footerText": "*𝐁𝐎𝐒𝐒 𝐕𝐈𝐁𝐔*", "thumbnail": fs.readFileSync('./media/imagen/cosplay/25.jpg'), "surface": 'CATALOG', "orderTitle": 'Sexo'}}, {contextInfo: { mentionedJid: [sender]}, quoted:choute, })
    leo.relayWAMessage(fansh)
    addFilter(from)
    addLevelingLevel(sender, 5)	}}
...
`${agra}`
  ...
  buttonsMessage = {
  contentText: `${txtt}`,
  footerText: '© Creator BOSS VIBU -', imageMessage: imageMsg,
  buttons: buttons1,
  headerType: 4}
...
case 'catalogo':
            ...
            fansh = leo.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": `${cantidad}`, "totalAmount1000" : '1000', "message": `${name}\n\n\nCreador is 𝐁𝐎𝐒𝐒 𝐕𝐈𝐁𝐔`, "footerText": "*𝐁𝐎𝐒𝐒 𝐕𝐈𝐁𝐔*", "thumbnail": ft, "surface": 'CATALOG', "orderTitle": 'Sexo'}}, {contextInfo: { mentionedJid: [sender]}, quoted:choute, })
            leo.relayWAMessage(fansh)
            break
...
case 'nuevo':
  fansh = leo.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 0, "totalAmount1000" : '1000', "message": `${nuevo}\n\n\nCreador is 𝐁𝐎𝐒𝐒 𝐕𝐈𝐁𝐔`, "footerText": "*𝐁𝐎𝐒𝐒 𝐕𝐈𝐁𝐔*", "thumbnail":  fs.readFileSync('./media/imagen/Faketumber.jpg'), "surface": 'CATALOG', "orderTitle": 'Sexo'}}, {contextInfo: { mentionedJid: [sender]}, quoted:choute, })
  leo.relayWAMessage(fansh)
  break
//════════════════════════════════════════ LOGOS ════════════════════════════════
